...
def main():
    ...
    scaling_params_df.to_csv(f"MPQ_gas_properties/Data/gas_scaling_parameters_{sim_name}_snap{snap}.csv", index = False)
    ...
    covs_df.to_csv(f"MPQ_gas_properties/Data/gas_covariances_{sim_name}_snap{snap}.csv", index = False)
    ...
    corrs_df.to_csv(f"MPQ_gas_properties/Data/gas_correlations_{sim_name}_snap{snap}.csv", index = False)
    ...
    mpq_df.to_csv(f"MPQ_gas_properties/Data/gas_MPQ_{sim_name}_snap{snap}.csv", index = False)
